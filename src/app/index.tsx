...
const handleLogin = async () => {
  ...
  try {
    ...
    // Evita erro se a API devolver resposta sem JSON válido
    let data: any = null;
    try {
    ...
    Alert.alert(
      'Erro de conexão',
      'Não foi possí­vel conectar à API. Verifique se ela está rodando e se o IP está correto.'
    );
  } finally {
    setLoading(false);
  }
...
const styles = StyleSheet.create({
  ...
  logo: {
    width: '100%',
    height: 220, // menor que 330 para evitar estourar em telas pequenas
    resizeMode: 'contain',
    marginTop:  100,
    alignSelf: 'center',
  },
